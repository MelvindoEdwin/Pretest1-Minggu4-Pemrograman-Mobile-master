...
import 'package:flutter_parcel_app/ui/widgets/bottom_nav.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: CustomScrollView(
        slivers: <Widget>[
          SliverAppBar(
            title: Padding(padding: const EdgeInsets.only(left: 24),
            child: Text("Track Parcel", style: Theme.of(context).textTheme.headline1),
            ),
            centerTitle: false,
            floating: true,
            snap: false,
            ...
            actions: [
              ...
              child: CircleAvatar(
                child: ClipOval(
                  child: Image.network('https://cdn.realsport101.com/images/ncavvykf/epicstream/4eee4ca6753c941fa2e54900dd61485f567bd0d5-1334x750.jpg?rect=1,0,1332,750&w=700&h=394&dpr=2'),
                ...
                children: [
                  Expanded(
                    child: Padding (
                      ...
                      children: [
                        Text("Enter Parcel number or scan QR code", style: Theme.of(context).textTheme.headline5,),
                        Padding(padding: const EdgeInsets.only(top: 7, bottom: 40),
                          child: Row(children: [
                            ...
                            Container(
                              ...
                              child: SvgPicture.asset('assets/images/icon_qrcode.svg'),
                            )
                          ],),
                        ),
                        SizedBox(
          ...
          SliverList(delegate: SliverChildListDelegate([
            Container(
              ...
              child: Column(
                crossAxisAlignment:   CrossAxisAlignment.start,
                children: <Widget>[
                  Text("My Parcels", style: Theme.of(context).textTheme.headline3,)
                ]
              ),
            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('In Transit', style: Theme.of(context).textTheme.headline4,),
                        const SizedBox(
                          height: 3,
                        ),
                        Text('Last update', style: Theme.of(context).textTheme.headline6,),
                        const SizedBox(
                          height: 12,
                        ),
                        Container(
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Text('Details', style: Theme.of(context).textTheme.bodyText2),
